...
QTdConnectionState::QTdConnectionState(QObject *parent)
    : QTdObject(parent)
{
}

QTdConnectionStateWaitingForNetwork::QTdConnectionStateWaitingForNetwork(QObject *parent)
    : QTdConnectionState(parent)
{
    setType(CONNECTION_STATE_WAITING_FOR_NETWORK);
}

QTdConnectionStateConnectingToProxy::QTdConnectionStateConnectingToProxy(QObject *parent)
    : QTdConnectionState(parent)
{
